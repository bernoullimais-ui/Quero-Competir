...
function getSwimAgeClasses(currentYear: number) {
  return [
    ...
    {
      label: "Até 40 anos",
      description: `Nascidos entre ${currentYear - 40} e ${currentYear - 31}`,
    ...
    {
      label: "Até 50 anos",
      description: `Nascidos entre ${currentYear - 50} e ${currentYear - 41}`,
    ...
    },
    {
      ...
      description: `Nascidos antes de ${currentYear - 50}`,
      birth_year_min: null,
